...
- **s3d_conv1d_float32_100.tflite** — full‑precision TensorFlow Lite model for evaluation and comparison.
- **s3d_conv1d_int8_100.tflite** — quantized TensorFlow Lite model optimized for deployment on microcontrollers and embedded devices.
